...
3. [buildNeo4jTypeDefs](https://neo4j-graphql-server.gitbook.io/docs/buildneo4jtypedefs) then augments the same typeDefs provided to your Neo4j-GraphQL schema.  
